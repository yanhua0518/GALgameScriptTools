...
extern "C"
{
	__declspec(dllexport) void DecompressData(unsigned char *, unsigned char *, int);
	__declspec(dllexport) unsigned char *CompressData(unsigned char *, int, int *, int);
	__declspec(dllexport) int FindMatch(unsigned char *, short, int, int *, int);
	__declspec(dllexport) void GenerateTable(unsigned char *, int);
	__declspec(dllexport) int SearchData(unsigned char *, int, unsigned char *, int, int *);
}
